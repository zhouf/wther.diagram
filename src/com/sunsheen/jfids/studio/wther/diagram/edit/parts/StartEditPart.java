...
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.StartItemSemanticEditPolicy;
import com.sunsheen.jfids.studio.wther.diagram.figure.StartNodeFigure;
...
public class StartEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		getFigure().addKeyListener(new KeyListener() {
			//取消键监听，屏蔽复制等操作
			@Override
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new StartNodeFigure((NodeImpl) view.getElement());
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StartLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(StartLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.StartEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
