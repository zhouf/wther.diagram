...
import com.sunsheen.jfids.studio.wther.diagram.dialog.TransactionDialog;
import com.sunsheen.jfids.studio.wther.diagram.edit.layout.CompomentBorderItemLocator;
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.TransactionItemSemanticEditPolicy;
...
import com.sunsheen.jfids.studio.wther.diagram.figure.TransactionNodeFigure;
 ...
 * @generated
 */
public class TransactionEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public TransactionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TransactionItemSemanticEditPolicy());
		...
		ToolTipForActivityListener toolTipForActivityListener = new ToolTipForActivityListener(
				(TransactionImpl) ((Node) getModel()).getElement(), this.getEditDomain());
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new TransactionNodeFigure((NodeImpl) view.getElement());
	}

	/**
	 * @generated
	 */
	public TransactionNodeFigure getPrimaryShape() {
		return (TransactionNodeFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof TransactionNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(TransactionNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.TransactionEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
	...
	public void performRequest(Request request) {
		if (request.getType().equals(REQ_OPEN)) {
			final Transaction transactionNode = (Transaction) ((Node) getModel()).getElement();
			final Map<String, Object> params = new HashMap<String, Object>();
			params.put("nodename", transactionNode.getName());
			params.put("varname", transactionNode.getExternal());
			params.put("comment", transactionNode.getComment());
			params.put("cantransfer", (transactionNode.isTransfer() ? "true" : "false"));

			DialogConfigParser parser = new TransactionDialog(params);
			...
			TransactionalEditingDomain domain = TransactionUtil.getEditingDomain(transactionNode);
			domain.getCommandStack().execute(new RecordingCommand(domain) {
				@Override
				protected void doExecute() {
					if (dialog.getReturnCode() == Dialog.OK) {
						transactionNode.setName((String) params.get("nodename"));
						transactionNode.setComment((String) params.get("comment"));
						transactionNode.setExternal((String) params.get("varname"));
						transactionNode.setTransfer((Boolean) params.get("cantransfer"));

						FlowImpl flow = (FlowImpl) (transactionNode.eContainer());
						VarStore varStore = new VarStore(flow.getVarstore());
						varStore.removeByFrom(VarStore.TRANSACTION_TYPE);
						varStore.appendVar(transactionNode.getExternal()
								+ ":com.sunsheen.jfids.system.database.IdsSession:" + VarStore.TRANSACTION_TYPE);
