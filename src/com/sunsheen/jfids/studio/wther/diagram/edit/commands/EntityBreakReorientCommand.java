 ...
 * @generated
 */
public class EntityBreakReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntityBreakReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return LogicBaseItemSemanticEditPolicy.getLinkConstraints().canExistEntityBreak_4006(getNewSource(),
				getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return LogicBaseItemSemanticEditPolicy.getLinkConstraints().canExistEntityBreak_4006(getOldSource(),
				getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setBreak(null);
		getNewSource().setBreak(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setBreak(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
