...
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.EndItemSemanticEditPolicy;
import com.sunsheen.jfids.studio.wther.diagram.figure.EndNodeFigure;
...
public class EndEditPart extends AbstractBorderedShapeEditPart {
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new EndNodeFigure((NodeImpl) view.getElement());
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof EndLabelEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(EndLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.EndEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
