...
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.TranscommitItemSemanticEditPolicy;
import com.sunsheen.jfids.studio.wther.diagram.edit.tip.ToolTipForActivityListener;
import com.sunsheen.jfids.studio.wther.diagram.figure.TranscommitNodeFigure;
 ...
 * @generated
 */
public class TranscommitEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public TranscommitEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TranscommitItemSemanticEditPolicy());
		...
		ToolTipForActivityListener toolTipForActivityListener = new ToolTipForActivityListener(
				(TranscommitImpl) ((Node) getModel()).getElement(), this.getEditDomain());
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new TranscommitNodeFigure((NodeImpl) view.getElement());
	}

	/**
	 * @generated
	 */
	public TranscommitNodeFigure getPrimaryShape() {
		return (TranscommitNodeFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof TranscommitNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(TranscommitNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.TranscommitEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
