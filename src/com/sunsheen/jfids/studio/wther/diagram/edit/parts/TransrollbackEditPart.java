...
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.TransrollbackItemSemanticEditPolicy;
import com.sunsheen.jfids.studio.wther.diagram.edit.tip.ToolTipForActivityListener;
import com.sunsheen.jfids.studio.wther.diagram.figure.TransrollbackNodeFigure;
 ...
 * @generated
 */
public class TransrollbackEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public TransrollbackEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TransrollbackItemSemanticEditPolicy());
		...
		ToolTipForActivityListener toolTipForActivityListener = new ToolTipForActivityListener(
				(TransrollbackImpl) ((Node) getModel()).getElement(), this.getEditDomain());
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new TransrollbackNodeFigure((NodeImpl) view.getElement());
	}

	/**
	 * @generated
	 */
	public TransrollbackNodeFigure getPrimaryShape() {
		return (TransrollbackNodeFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof TransrollbackNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(TransrollbackNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.TransrollbackEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
		if (targetEditPart instanceof AssignmentEditPart) {
			types.add(LogicElementTypes.EntityExceptionlink_4007);
