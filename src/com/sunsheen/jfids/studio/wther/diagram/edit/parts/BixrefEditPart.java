...
import com.sunsheen.jfids.studio.wther.diagram.dialog.BixrefDialog;
import com.sunsheen.jfids.studio.wther.diagram.edit.layout.CompomentBorderItemLocator;
import com.sunsheen.jfids.studio.wther.diagram.edit.policies.BixrefItemSemanticEditPolicy;
...
import com.sunsheen.jfids.studio.wther.diagram.figure.BixrefNodeFigure;
 ...
 * @generated
 */
public class BixrefEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public BixrefEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new BixrefItemSemanticEditPolicy());
		...
		ToolTipForActivityListener toolTipForActivityListener = new ToolTipForActivityListener(
				(BixrefImpl) ((Node) getModel()).getElement(), this.getEditDomain());
	...
	protected IFigure createNodeShape() {
		...
		return primaryShape = new BixrefNodeFigure((NodeImpl) view.getElement());
	}

	/**
	 * @generated
	 */
	public BixrefNodeFigure getPrimaryShape() {
		return (BixrefNodeFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof BixrefNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LogicVisualIDRegistry.getType(BixrefNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof com.sunsheen.jfids.studio.wther.diagram.edit.parts.BixrefEditPart) {
			types.add(LogicElementTypes.NodeLink_4001);
		}
	...
	public void performRequest(Request request) {
		if (request.getType().equals(REQ_OPEN)) {
			final Bixref bixrefNode = (Bixref) ((Node) getModel()).getElement();
			// 获得FLOW，并通过 FLOW获取页面的变量定义
			final FlowImpl flow = (FlowImpl) ((Diagram) ((Node) getModel()).eContainer()).getElement();
			final Map<String, Object> params = paramBuilder(bixrefNode);
			...
			params.put("ext", bixrefNode.getExternal());

			DialogConfigParser parser = new BixrefDialog(params);
			...
			TransactionalEditingDomain domain = TransactionUtil.getEditingDomain(bixrefNode);
			domain.getCommandStack().execute(new RecordingCommand(domain) {
				@Override
				protected void doExecute() {
					if (dialog.getReturnCode() == Dialog.OK) {
						dealDlgOK(bixrefNode, params);
						if (params.containsKey(Constant.NEED_CREATE_VAR)) {
							...
							System.out.println("CallEditPart performRequest()-> :创建flow变量定义createVarStr="
									+ createVarStr);
						}
					}
				}
	 ...
	 * @return 返回的参数对象
	 */
	private Map<String, Object> paramBuilder(BixCall call) {
		return BixCallEditPartUtil.paramBuilder(call);
	}
	 ...
	 * @param params
	 */
	private void dealDlgOK(Bixref callNode, final Map<String, Object> params) {
