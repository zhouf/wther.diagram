 ...
 * @author zhouf
 */
public class DataPortArgItem {
	static final org.apache.log4j.Logger log = com.sunsheen.jfids.studio.logging.LogFactory.getLogger(DataPortArgItem.class.getName());
	
	private int seq;
	private String varType;
	private String varName;
	
	public DataPortArgItem() {
		this("");
	}
	
	public DataPortArgItem(String initStr){
		...
		if(StringUtils.isNotEmpty(initStr)){
			...
			try{
				...
				this.seq = 1;
				log.warn("DataPortArgItem.DataPortArgItem()->:seq转换异常，seq=" + items[0]);
			}
