...
public class DefaultProposalRender extends AbstractProposalRender implements IProposalRender {
	static final org.apache.log4j.Logger log = com.sunsheen.jfids.studio.logging.LogFactory.getLogger(DefaultProposalRender.class.getName());
	...
	private boolean typeMatch(String varStr, String requestType) {
		...
		if(blankIndex>0){
			...
			retVal = JavaTypeUtil.typeMatch(varType,requestType); 
		}else{
			//没有空格，则说明没有类型，直接给出提示
			retVal = true;
		}
