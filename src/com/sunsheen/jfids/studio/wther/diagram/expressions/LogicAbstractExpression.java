package com.sunsheen.jfids.studio.wther.diagram.expressions;
 ...
 * @generated
 */
public abstract class LogicAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = LogicDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected LogicAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
	...
	public Object evaluate(Object context, Map env) {
		if (context().isInstance(context)) {
			try {
				...
				LogicDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body(), e); //$NON-NLS-1$
			}
		}
		return null;
	}
