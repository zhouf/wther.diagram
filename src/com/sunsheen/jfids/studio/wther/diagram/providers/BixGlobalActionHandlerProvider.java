...
public class BixGlobalActionHandlerProvider extends AbstractGlobalActionHandlerProvider {
	 ...
	 */
	public BixGlobalActionHandlerProvider() {
		super();
	}
	...
	public IGlobalActionHandler getGlobalActionHandler(
		...
		if (!getHandlerList().containsKey(context.getActivePart())) {
			getHandlerList().put(context.getActivePart(),new BixDiagramGlobalActionHandler());
		...
		return (BixDiagramGlobalActionHandler) getHandlerList().get(
